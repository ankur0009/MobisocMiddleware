...
public class InterestDrink implements ElementMatch {
	public static final String NAME = "drink";
	public static final String PRINT_NAME = "Cocktails I Like";
	public static final String DESCRIPTION = "Do we like similar  Drinks?";
 ...
 public InterestDrink() {
       super();
 }
	public InterestDrink(ProfInterface profIn) {
		super();
		this.profIn = profIn;
		this.setWeight(1.0);
		this.setScore(0);
	...
	public int numEntryFirstUser() {
		return profIn.numOfDrinkUser();
	}
	public int numEntrySecondUser() {
		return profIn.numOfDrinkFriend();
	}
	public int numMatchedEntries() {
		return profIn.numDrink();
	}
