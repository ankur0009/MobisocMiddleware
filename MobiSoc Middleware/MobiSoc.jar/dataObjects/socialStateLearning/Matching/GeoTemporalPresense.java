...
public class GeoTemporalPresense implements ElementMatch {
	public static final String NAME = "presense";
	public static final String PRINT_NAME = "Common Places";
	public static final String DESCRIPTION = "Do We Spend Time at the Same Places, but maybe at different times?";
 ...
 public GeoTemporalPresense() {
       super();
 }
	public GeoTemporalPresense(ProfInterface profIn) {
		super();
		this.profIn = profIn;
		this.setWeight(1.0);
		this.setScore(0);
	...
	public int numEntryFirstUser() {
		return profIn.numOfPresenseUser();
	}
	public int numEntrySecondUser() {
		return profIn.numOfPresenseFriend();
	}
	public int numMatchedEntries() {
		return profIn.numPresense();
	}
	...
	public int getId() {
		return ElementMatch.PRESENSE_ID;
	}
