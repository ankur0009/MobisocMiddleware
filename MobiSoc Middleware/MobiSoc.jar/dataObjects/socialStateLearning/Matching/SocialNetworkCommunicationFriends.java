...
public class SocialNetworkCommunicationFriends implements ElementMatch {
	public static final String NAME = "communicationfriends";
	public static final String PRINT_NAME = "Talk To My Friends";
	public static final String DESCRIPTION = "Does She/He Communicate With My Friends?";
 ...
 public SocialNetworkCommunicationFriends() {
       super();
 }
	public SocialNetworkCommunicationFriends(ProfInterface profIn) {
		super();
		this.profIn = profIn;
		this.setWeight(1.0);
		this.setScore(0);
	...
	public int numEntryFirstUser() {
		return profIn.numOfCommunicationFriendsUser();
	}
	public int numEntrySecondUser() {
		return profIn.numOfCommunicationFriendsFriend();
	}
	public int numMatchedEntries() {
		return profIn.numCommunicationFriends();
	}
	...
	public int getId() {
		return ElementMatch.COMMUNICATIONFRIENDS_ID;
	}
