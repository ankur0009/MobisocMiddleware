...
public class SocialNetworkCommonGroup implements ElementMatch {
	public static final String NAME = "commongroup";
	public static final String PRINT_NAME = "Common Group";
	public static final String DESCRIPTION = "Are We Members of The Same Groups?";
 ...
 public SocialNetworkCommonGroup() {
       super();
 }
	public SocialNetworkCommonGroup(ProfInterface profIn) {
		super();
		this.profIn = profIn;
		this.setWeight(1.0);
		this.setScore(0);
	...
	public int numEntryFirstUser() {
		return profIn.numOfCommonGroupUser();
	}
	public int numEntrySecondUser() {
		return profIn.numOfCommonGroupFriend();
	}
	public int numMatchedEntries() {
		return profIn.numCommonGroup();
	}
	...
	public int getId() {
		return ElementMatch.COMMONGROUP_ID;
	}
