...
public class PhysicalEyeColor implements ElementMatch {
	public static final String NAME = "eyecolor";
	public static final String PRINT_NAME = "Eye Color";
	public static final String DESCRIPTION = "Her/His Eye Color";
 ...
 public PhysicalEyeColor() {
       super();
 }
	public PhysicalEyeColor(ProfInterface profIn) {
		super();
		this.profIn = profIn;
		this.setWeight(1.0);
		this.setScore(0);
	...
	public int numEntryFirstUser() {
		return profIn.numOfEyeColorUser();
	}
	public int numEntrySecondUser() {
		return profIn.numOfEyeColorFriend();
	}
	public int numMatchedEntries() {
		return profIn.numEyeColor();
	}
	...
	public int getId() {
		return ElementMatch.EYECOLOR_ID;
	}
