...
public class BasicCountry implements ElementMatch {
	public static final String NAME = "country";
	public static final String PRINT_NAME = "Nationality/Country Of Origin";
	public static final String DESCRIPTION = "Her/His Nationality";
 ...
 public BasicCountry() {
	...
	public BasicCountry(ProfInterface profIn) {
		super();
		this.profIn = profIn;
		this.setWeight(1.0);
		this.setScore(0);
	...
	public int numEntryFirstUser() {
		return profIn.numOfCountryUser();
	}
	public int numEntrySecondUser() {
		return profIn.numOfCountryFriend();
	}
	public int numMatchedEntries() {
		return profIn.numCountry();
	}
	...
	public int getId() {
		return ElementMatch.COUNTRY_ID;
	}
