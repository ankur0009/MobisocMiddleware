...
public class SocialNetworkMutualFriends implements ElementMatch {
	public static final String NAME = "mutualfriends";
	public static final String PRINT_NAME = "Mutual Friends";
	public static final String DESCRIPTION = "Do We Have Common Friends?";
 ...
 public SocialNetworkMutualFriends() {
       super();
 }
	public SocialNetworkMutualFriends(ProfInterface profIn) {
		super();
		this.profIn = profIn;
		this.setWeight(1.0);
		this.setScore(0);
	...
	public int numEntryFirstUser() {
		return profIn.numOfMutualFriendsUser();
	}
	public int numEntrySecondUser() {
		return profIn.numOfMutualFriendsFriend();
	}
	public int numMatchedEntries() {
		return profIn.numMutualFriends();
	}
	...
	public int getId() {
		return ElementMatch.MUTUALFRIENDS_ID;
	}
