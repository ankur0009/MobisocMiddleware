...
/**
 * 
 * The Coordinates class represents coordinates as latitude-longitude-altitude-floor
...
public class Coordinates {
	 ...
	 */
	public Coordinates(double latitude, double longitude, double altitude, int floor) {
 ...
 The longitude is given in WGS84 datum.
	...
	/**
	 * Returns the floor component of this coordinate. 
	 * @return the floor
	 * @see 
	 */
	public int getFloor () {
	 ...
	 *             if the parameter is null
	 */
	public float groundDistance(Coordinates to) {
		...
		//Modified by Ankur Gupta & Sanil Paul. There was error in the formula Below
	...
	/**
	 * Calculates the floor diffence between two points. The difference
	 * is source minus the destination
	 *  
	 *  
	 * @param to
	 *            the Coordinates of the destination
	 * @return the floor diffence to the destination
	 * @throws java.lang.NullPointerException
	 *             if the parameter is null
	 */
	public double floorDifference(Coordinates to) {
		return  this.getFloor()-to.getFloor();	
	}
	...
	/**
	 * Calculates the height diffence between two points. The difference
	 * is source minus the destination
	 *  
	 *  
	 * @param to
	 *            the Coordinates of the destination
	 * @return the height diffence to the destination
	 * @throws java.lang.NullPointerException
	 *             if the parameter is null
	 */
	public double heightDifference(Coordinates to) {
		return  this.getAltitude()-to.getAltitude();	
	}
	
	/**
	 * Calculates the distance between two points taking into account
	 * the longitude, latitude and the height. The function is currently
	 * not implemented 
	 *  
	 * @param to
	 *            the Coordinates of the destination
	 ...
	 *             if the parameter is null
	 */
	public double actualDistance(Coordinates to) {
		return  0;	
	}
