...
public class PhysicalMatch implements MatchInterface {
	...
	public static final String PRINT_NAME = "Physical Attributes";
	...
	public PhysicalMatch(ProfInterface profIn) {
		super();
		weight = 1.0;
		this.profIn = profIn;
		...
		elements.add(new PhysicalHeight((profIn)));
		elements.add(new PhysicalEyeColor((profIn)));
		elements.add(new PhysicalGender((profIn)));
