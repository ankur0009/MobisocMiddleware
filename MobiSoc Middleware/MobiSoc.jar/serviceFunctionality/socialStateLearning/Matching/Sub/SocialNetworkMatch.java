...
public class SocialNetworkMatch implements MatchInterface {
	...
	public SocialNetworkMatch(ProfInterface profIn) {
		super();
		this.profIn = profIn;
		weight = 1.0;
		...
		elements.add(new SocialNetworkCommunicationFriends((profIn)));
		elements.add(new SocialNetworkFriendsKnowsFriends((profIn)));
		elements.add(new SocialNetworkCoPresenseFriends((profIn)));
