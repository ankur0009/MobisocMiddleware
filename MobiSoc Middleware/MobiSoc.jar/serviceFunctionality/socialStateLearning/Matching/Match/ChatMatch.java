...
public class ChatMatch implements MatchInterface {
	...
	public static final String NAME = "chatmatch";

	public static final String PRINT_NAME = "Chat/Email/IM/Talk";

	private String generatefunction = GenerateScore.GENERATE_LOCAL;

	public double weight;

	public ChatMatch(Long userid, Long friendid) {
		super();
		this.userid = userid;
