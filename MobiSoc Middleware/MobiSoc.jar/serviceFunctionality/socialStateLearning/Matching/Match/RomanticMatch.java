...
public class RomanticMatch implements MatchInterface {
	...
	public static final String NAME = "romanticmatch";

	public static final String PRINT_NAME = "Romantic";

	private String generatefunction = GenerateScore.GENERATE_LOCAL;

	public double weight;

	public RomanticMatch(Long userid, Long friendid) {
		super();
		this.userid = userid;
	...
	public long getMatchId() {
		...
		return MATCH_TYPE_ROMANTIC_MATCH_ID;
	}
	public int getScore() {
		if(score==null)
			score=generateScore();
