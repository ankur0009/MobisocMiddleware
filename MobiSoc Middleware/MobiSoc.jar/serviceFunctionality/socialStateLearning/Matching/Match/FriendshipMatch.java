...
public class FriendshipMatch implements MatchInterface {
	...
	public static final String NAME = "friendshipmatch";

	public static final String PRINT_NAME = "Friendship";

	private String generatefunction = GenerateScore.GENERATE_LOCAL;

	public double weight;

	public FriendshipMatch(Long userid, Long friendid) {
		super();
		this.userid = userid;
	...
	public long getMatchId() {
		...
		return MATCH_TYPE_FRIENDSHIP_ID;
	}
	public int getScore() {
		if(score==null)
			score=generateScore();
