...
public class HangoutMatch implements MatchInterface {
	...
	public static final String NAME = "hangoutmatch";

	public static final String PRINT_NAME = "Hangout";

	private String generatefunction = GenerateScore.GENERATE_LOCAL;

	public double weight;

	public HangoutMatch(Long userid, Long friendid) {
		super();
		this.userid = userid;
