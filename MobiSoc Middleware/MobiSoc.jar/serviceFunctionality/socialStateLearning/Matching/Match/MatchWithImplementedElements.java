...
import serviceFunctionality.socialStateLearning.Matching.Sub.ImplementedInterest;
...
import serviceFunctionality.socialStateLearning.Matching.Sub.PhysicalMatch;
...
public class MatchWithImplementedElements implements MatchInterface {
	...
	public MatchWithImplementedElements(Long userid, Long friendid) {
		super();
		this.userid = userid;
		...
		subClasses.add(new ImplementedGeo(profIn));
		subClasses.add(new ImplementedSocial(profIn));
		subClasses.add(new ImplementedInterest(profIn));
		subClasses.add(new ImplementedBasic(profIn));
		subClasses.add(new ImplementedPhysical(profIn));
